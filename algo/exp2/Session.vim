...
silent only
silent tabonly
cd /media/cjsoft/CJS/git-repos/HomeWork/algo/exp2
...
silent! normal! zE
let s:l = 43 - ((33 * winheight(0) + 20) / 41)
...
setlocal indentkeys=0{,0},:,!^F,o,O,e,<:>,=elif,=except,0=then,0=do,0=else,0=elif,0=fi,0=esac,0=done,0=end,),0=;;,0=;&,0=fin,0=fil,0=fip,0=fir,0=fix
setlocal noinfercase
setlocal iskeyword=@,48-57,_,192-255
setlocal keywordprg=
set linebreak
