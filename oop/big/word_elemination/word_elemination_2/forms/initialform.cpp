...
//    ui->lblProject->setText(QChar(fa::graduationcap) + ui->lblProject->text());
    ui->lblIcon->setText(QChar(fa::graduationcap));
    ui->lblIcon->setFont(awesome->font(18));
    ...
    setWH(ui->gb->x() + ui->gb->width() + 10, ui->gb->y() + ui->gb->height() + 10);
//    ServerConnect tmp;
...
void InitialForm::on_btnRegister_clicked()
{
    ui->gb_2->show();
    ui->gb->hide();
    setWH(ui->gb_2->x() + ui->gb_2->width() + 10, ui->gb_2->y() + ui->gb_2->height() + 10);
