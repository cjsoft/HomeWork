...
silent only
silent tabonly
cd /media/cjsoft/CJS/git-repos/HomeWork/oop/exp2/1
...
argglobal
if bufexists('geometry.h') | buffer geometry.h | else | edit geometry.h | endif
let s:cpo_save=&cpo
set cpo&vim
...
wincmd w
argglobal
if bufexists('geometry.cpp') | buffer geometry.cpp | else | edit geometry.cpp | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 77 - ((23 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
77
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 30 - ((25 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
30
